...
class WorkAdapter(private val context : Context) : RecyclerView.Adapter<WorkAdapter.ViewHolder>() {
     ...
     override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
          val binding = WorkFragmentItemBinding.inflate(LayoutInflater.from(parent.context),parent,false)
...
holder.binding.location.text = workExperience.location
     ...
     inner class ViewHolder(val binding : WorkFragmentItemBinding) : RecyclerView.ViewHolder(binding.root){
